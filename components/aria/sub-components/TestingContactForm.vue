        ...
        <div class="row align-items-center">
          <div class="col-lg-6 col-lg-6">
            <div class="conact-us-wrap-one mb-30">
              <h3 class="heading">
                To make requests for <br>Testing information, <br><span class="text-color-primary">contact us.</span>
              </h3>
              <div class="sub-heading">
                Need to register or schedule please call or email us to get set up.
              </div>
              <div class="sub-heading">
                Call Now: <a style="color: #c12443;" href="tel:3177339454">317-733-9454</a>
              </div>
              <div class="sub-heading" />
            </div>
          </div>
